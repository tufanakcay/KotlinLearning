package com.tufanakcay.kotlinlearning
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mixedArray = arrayOf("Tufan",5)
        ...
        myStringArrayList.add("Tufan")
        myStringArrayList.add("Akcay")
        myStringArrayList.add("Zero")
